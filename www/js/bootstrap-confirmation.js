	...
	* ======================= */
	...
	$.fn.confirmation.defaults = $.extend({} , $.fn.tooltip.defaults, {
		...
		, template: '<div class="popover">' +
				'<div class="arrow"></div>' +
				'<h3 class="popover-title">роро</h3>' +
				'<div class="popover-content text-center">' +
				'<div class="btn-group" width="200px">' +
				'<a class="btn btn-sm" href="" target=""></a>&nbsp;' +
				'<a class="btn btn-sm" data-dismiss="confirmation"></a>' +
				'</div>' +
				'</div>' +
				'</div>'
		, btnOkClass:  'btn-danger'
		, btnCancelClass:  'btn-default'
		, btnOkLabel: '<span class="glyphicon glyphicon-ok-sign glyphicon-white"></span> Да'
		, btnCancelLabel: '<span class="glyphicon glyphicon-remove-sign"></span> Нет'
		, singleton: false
		, popout: false
		, onConfirm: function(){}
		, onCancel: function(){}
