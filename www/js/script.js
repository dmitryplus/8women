...
//
	...
	MakeDelButton( "region", "del-region", "Удалить регион?", "Регион удален", "Ошибка удаления региона" );
	MakeDelButton( "part", "del-region", "Удалить рубрику?", "Рубрика удалена", "Ошибка удаления рубрики" );
