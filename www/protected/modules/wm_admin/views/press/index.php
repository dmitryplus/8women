...
<? foreach ( $this->allRec as $one ) { ?>
	<tr data-id="<? echo $one->id; ?>">
		...
		<td>
			...
			<a href="<? echo Yii::app()->getBaseUrl(true).'/wm_admin/press/edit/'.$one->id?>"  role="button" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="left" title="Редактировать ссылку"><span class="glyphicon glyphicon-edit"></span></a>


		</td>

		<td width="45px" class="text-center">
			<a href="#" data-id="<?=$one->id?>" role="button" class="btn btn-default btn-sm" data-bb="press"  data-toggle="tooltip" data-placement="left" title="Удалить ссылку"><span class="glyphicon glyphicon-trash"></span></a>
		</td>
...
<tfoot><tr><td colspan=7>
		...
		<a href="<? echo Yii::app()->getBaseUrl(true).'/wm_admin/press/edit'; ?>" class="btn btn-primary btn-new" ><span class="glyphicon glyphicon-plus"></span> Добавить ссылку</a>
		</div>
